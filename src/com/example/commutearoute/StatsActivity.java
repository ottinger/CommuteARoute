...
public class StatsActivity extends FragmentActivity implements
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			switch (position) {
			case 0:
				fragment = new StatsSummaryFragment();
				return fragment;
			case 1: 
				fragment = new StatsAlternativesFragment();
				return fragment;
			case 2:
				fragment = new StatsGraphsFragment();
				return fragment;
			}
			return fragment;
		}
		...
		public CharSequence getPageTitle(int position) {
			...
			case 1:
				return getString(R.string.title_alternatives).toUpperCase(l);
			case 2:
